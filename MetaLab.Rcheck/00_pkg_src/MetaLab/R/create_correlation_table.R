...
create_correlation_table <- function(data,
  ...
  if (!requireNamespace("Hmisc", quietly = TRUE)) {
    stop("Package `Hmisc` is required for `create_correlation_table()` (install it via install.packages('Hmisc')).")
  }
  ...
  if (!requireNamespace("flextable", quietly = TRUE)) {
    stop("Package `flextable` is required to write a .docx (install it via install.packages('flextable')).")
  }
  if (!requireNamespace("officer", quietly = TRUE)) {
    stop("Package `officer` is required to write a .docx (install it via install.packages('officer')).")
  }
